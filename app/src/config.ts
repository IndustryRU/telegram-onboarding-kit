  ...
  pages: [
      ...
      slides: [
        // Быстрый старт
        {
          ...
          description:
            "1111 Чтобы оперативно приступить к выполнению работ в системе, посмотрите краткую видеоинстукцию <b>Быстрый старт</b>.<br><br>Это поможет начать работу <b>просто</b>, <b>быстро</b> и <b>легко!</b><br><br>По мере получения навыков и опыта работы с системой изучайте подробные видеоматериалы и повышайте свою эффективность!",
          list: [
            {
              media: {
                type: 'icon',
